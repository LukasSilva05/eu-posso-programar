export default function Home() {
  return (
    <div className="pt-12 max-sm:pt-4 ">
      ...
      <p className="text mt-8 text-lg max-sm:text-base text-zinc-300/90 leading-relaxed tracking-wide">
      ...
      <p className="text text-lg max-sm:text-base text-zinc-300/90 leading-relaxed tracking-wide my-10">
        <span className="text-white text-xl">JavaScript</span> <span className="px-1">→</span> Linguagem de programação que permite implementar itens complexos em páginas web — toda vez que uma página da web faz mais do que simplesmente mostrar a informação estática — mostrando conteúdo que se atualiza em um intervalo de tempo, mapas interativos ou gráficos 2D/3D animados, etc. — você pode apostar que o JavaScript provavelmente está envolvido.
      </p>
      <p className="text text-lg max-sm:text-base text-zinc-300/90 leading-relaxed tracking-wide my-10">
        <span className="text-white text-xl">HTML</span> <span className="px-1">→</span> (Linguagem de Marcação de HiperTexto) é o bloco de construção mais básico da web. É o código que você usa para estruturar uma página web e seu conteúdo. Por exemplo, o conteúdo pode ser estruturado em parágrafos, em uma lista com marcadores ou usando imagens e tabelas.
      </p>
      <p className="text text-lg max-sm:text-base text-zinc-300/90 leading-relaxed tracking-wide my-10">
        <span className="text-white text-xl">CSS</span> <span className="px-1">→</span>(Cascading Style Sheets ou Folhas de Estilo em Cascata) é uma linguagem de estilo usada para descrever a apresentação de um documento escrito em HTML, ou seja, é o código que você usa para dar estilo à sua página. Por exemplo, trocando cores, fontes, tamanhos e até ajustando sua página a diferentes tipos de dispositivos.
      </p>
    </div>
  );
}
